...
void windows::on_creerCompte_clicked()
{
    QString nom = QInputDialog::getText(this, "Input dialog","Nom à attribuer à votre compte", QLineEdit::Normal);
    QString id;
    if(!nom.isEmpty()){
    m_gestionnaireDialogue.ajouterCompteP(nom,id.number(m_id));
    identifierUtilisateur(m_gestionnaireDialogue.identifierUtilisateur(m_id));
    }
}


void windows::on_creerCagnotte_clicked()
{
    QString nom = QInputDialog::getText(this, "Input dialog","Nom à attribuer à votre cagnotte", QLineEdit::Normal);
    QString id;
    if(!nom.isEmpty()){
    m_gestionnaireDialogue.ajouterCagnotte(nom,id.number(m_id));
    identifierUtilisateur(m_gestionnaireDialogue.identifierUtilisateur(m_id));
    }
}

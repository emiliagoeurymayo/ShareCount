...
void GestionnaireDialogue::ajouterCompteP(QString nom,QString id){
    m_gbdd.addComptePartage(nom.toStdString(),id.toStdString());
}

void GestionnaireDialogue::ajouterCagnotte(QString nom,QString id){
    m_gbdd.addCagnotte(id.toInt(),0,nom.toStdString(),id.toStdString());
}
